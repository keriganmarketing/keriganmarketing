...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_tether__ = __webpack_require__(331);
...
window.jQuery = window.$ = __webpack_require__(330);
...
window.loadVideo = function () {
    ...
    var videoContent = '<div id="big-video-wrap">' + '<div id="big-video-vid">' + '<video width="100%" height="auto" autoplay loop muted >' + '<source src="/wp-content/themes/kma/vid/kma3.mp4" type="video/mp4" >' + '</video>' + '</div>' + '</div>';
...
window.rotateTestimonials = function () {
    (function () {
        ...
        function showNextQuote() {
            ++quoteIndex;
            quotes.eq(quoteIndex % quotes.length).fadeIn(0).delay(5000).fadeOut(0, showNextQuote);
        }
